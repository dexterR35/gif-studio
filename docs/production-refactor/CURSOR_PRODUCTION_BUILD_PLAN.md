...
> **Repo path:** `docs/production-refactor/CURSOR_PRODUCTION_BUILD_PLAN.md` (primary execution).  
> **Locked overlays (win for compute / enhanced):** [../GIF_STUDIO_MEGA_SENIOR_BUILD.md](../GIF_STUDIO_MEGA_SENIOR_BUILD.md) §2 — server-first Best AI + export; enhanced = **replace source + rollback** (not invisible underlay; overrides §5.3 / Phase 3 “alternate A/B” wording below when they conflict).
