/** @typedef {'UNSUPPORTED_FORMAT'|'INVALID_IMAGE'|'PROJECT_VALIDATION_FAILED'|'PROJECT_MIGRATION_FAILED'|'ASSET_MISSING'|'FONT_MISSING'|'MODEL_UNAVAILABLE'|'MODEL_OUT_OF_MEMORY'|'TASK_CANCELLED'|'STALE_RESULT_DISCARDED'|'UNAUTHORIZED'|'RATE_LIMITED'|'INTERNAL_ERROR'} StudioErrorCode */
