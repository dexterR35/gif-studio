...
export function StudioHeader() {
  const {
    mobilePanel, setMobilePanel, reset, exportGif, exporting,
  } = useStudio()
  ...
  return (
    <header className="relative z-40 flex h-12 shrink-0 items-center justify-between border-b border-white/[.07] bg-ink/95 px-4 backdrop-blur md:px-5">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="primary" size="md" onClick={exportGif} disabled={exporting} className="font-bold disabled:opacity-70">
