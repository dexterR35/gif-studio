 ...
 * transform and settings controls.
...
export function SecondaryAside({
  ...
  return (
    <aside
      aria-hidden={!open}
      className={cn(
        'scrollbar absolute inset-y-0 right-0 z-20 h-full overflow-y-auto overscroll-contain border-l border-white/[.06] bg-panel px-3 lg:relative lg:inset-auto lg:shrink-0',
        open
          ...
          <div className="sticky top-0 z-10 flex h-11 items-center justify-between border-b border-white/[.06] bg-panel">
            ...
            {onClose && (
              <button
                ...
                className="focus-ring rounded-md p-1 text-zinc-500 hover:text-zinc-200"
              >
