"""PostgreSQL models for Image Studio projects.

Uses SQLAlchemy when installed and DATABASE_URL is set. Otherwise callers
fall back to in-memory or client-side behavior.
"""
...
def database_url() -> str | None:
    return os.environ.get("DATABASE_URL") or os.environ.get("IMAGE_STUDIO_DATABASE_URL")
