...
/** Right-inspector image processing controls for the Effects workspace. */
export function EffectsPanel() {
  const {
    settings, update,
    imageEdits, setImageEdits,
    activeEffects, updateEffect, effectTarget,
  ...
  return (
    <>
      <Section
        title="Effects"
        info="Image processing for the selected layer — color, blur, distortion, and frames. Pick a layer in the Layers panel."
      >
      ...
      {showBaseQuick && (
        <Section title="Quick adjustments" open={false}>
